...
> Vendored from [blader/humanizer](https://github.com/blader/humanizer) (MIT). Removes signs of AI-generated writing so prose sounds more natural. Call `getSkill('humanizer')` before publishing external writing (papers, dossiers, tweets, docs).
