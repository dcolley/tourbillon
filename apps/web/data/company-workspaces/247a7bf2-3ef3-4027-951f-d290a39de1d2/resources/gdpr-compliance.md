...
- Users can request all personal data we hold about them via `privacy@tourbillon.dev`
...
**Procedure:**
1. User submits deletion request via settings → "Delete Account" or email `privacy@tourbillon.dev`
